/*
 * authors:   Linus Schwab  (09-125-592)
 *            Neyah Rizello (08-919-961)
 */
...
/* ORI */
void test_ori() {
    test_execute(create_itype_hex(0x0001, I_T0, I_T1, OC_ORI));
	assert(T0 == 0x00000001);
	
	T1 = 0x1111;
    test_execute(create_itype_hex(0x0000, I_T0, I_T1, OC_ORI));
	assert(T0 == 0x00001111);
